...
namespace NSC.GridPlan.PowerEquipment.UI
{
    public partial class EquipmentInfoShow : Form
    {
        ...
        private DevExpress.XtraVerticalGrid.VGridControl vGridControli;
       ...
       /// <param name="TypeName"></param>
        ...
        /// <summary>
         /// VGridControl 行宽自动调整
        /// </summary>
         private void RecalcWidth(DevExpress.XtraVerticalGrid.VGridControl vGridControly)
         {
             int recordWidth = (vGridControly.Width - vGridControly.RowHeaderWidth) / vGridControly.Rows.Count;
             if (recordWidth > vGridControly.RecordMinWidth)
             {
                 vGridControly.RecordWidth = recordWidth;
                 vGridControly.ScrollVisibility = DevExpress.XtraVerticalGrid.ScrollVisibility.Vertical;
             }
             else
             {
                 vGridControly.ScrollVisibility = DevExpress.XtraVerticalGrid.ScrollVisibility.Auto;
             }
         }
        /// <summary>
        /// 填充单个组表格
        ...
        /// <param name="e"></param>
         ...
         public void megreGridControl(DevExpress.XtraVerticalGrid.VGridControl vGridControlm, int vGi)
         {
             //this.tableLayoutPanel1.row
             if (vGi==1)
             { vGridControli = this.vGridControl1; }
             else if (vGi == 3)
             { vGridControli = this.vGridControl3; }
             else
             { vGridControli = this.vGridControl2; }
             //vGridControli = new DevExpress.XtraVerticalGrid.VGridControl();
             if (vGridControlm.Tag != null)
             { 
             nCategoryRow = new DevExpress.XtraVerticalGrid.Rows.CategoryRow();
             nCategoryRow.Properties.Caption = vGridControlm.Tag.ToString();
             vGridControli.Rows.AddRange(new DevExpress.XtraVerticalGrid.Rows.BaseRow[] {
             this.nCategoryRow});
             nCategoryRow.Grid.Dock = DockStyle.Fill;
             //RecalcWidth(vGridControli);
             for (int j = 0; j < vGridControlm.Rows.Count; j++)
             {
                 mCategoryRow = new DevExpress.XtraVerticalGrid.Rows.CategoryRow();
                 mCategoryRow.Properties.Caption = vGridControlm.Rows[j].Properties.Caption;
                 this.nCategoryRow.ChildRows.AddRange(new DevExpress.XtraVerticalGrid.Rows.BaseRow[] {
                 this.mCategoryRow});
                 //this.vGridControl1.Rows.AddRange(new DevExpress.XtraVerticalGrid.Rows.BaseRow[] {this.mCategoryRow});
                 mCategoryRow.Grid.Dock = DockStyle.Fill;
                 RecalcWidth(vGridControli);
                 ...
                 for (int i = 0; i < vGridControlm.Rows[j].ChildRows.Count; i++)
                 {
                     ...
                     this.mEditorRow.Properties.FieldName = vGridControlm.Rows[j].ChildRows[i].Properties.FieldName;
                     this.mEditorRow.Properties.Caption = vGridControlm.Rows[j].ChildRows[i].Properties.Caption;
                     this.mEditorRow.Height = 18;// vGridControlm.Rows[j].ChildRows[i].Height;
                     this.mEditorRow.Appearance.Options.UseForeColor = true;
             ...
             //this.vGridControl1.DataSource

             vGridControli.DataSource = vGridControlm.DataSource;
             vGridControli.BestFit();
             //vGridControli.OptionsView.FixRowHeaderPanelWidth = true;
             //vGridControli.OptionsView.AutoScaleBands = true;
             //
