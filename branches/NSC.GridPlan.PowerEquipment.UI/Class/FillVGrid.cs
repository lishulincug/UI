    ...
    public class FillVGrid
    {
        ...
        private EditorRow FillRowData(RowTable mRowTable)
        {
            ...
            if (mRowTable.IsHasChild)
            {
                ...
                childRow});
                    DevExpress.XtraVerticalGrid.Rows.EditorRow[] editorRow = new DevExpress.XtraVerticalGrid.Rows.EditorRow[3];
                    editorRow[0] = new DevExpress.XtraVerticalGrid.Rows.EditorRow();
                    editorRow[0].Name = "editorRows0";
                    editorRow[0].Properties.Caption = "	                参数名称";
                    //editorRow[0].Properties.ReadOnly;
                    editorRow[0].Tag = "0";
                    DevExpress.XtraEditors.Repository.RepositoryItemTextEdit rite0 = new DevExpress.XtraEditors.Repository.RepositoryItemTextEdit();
                    editorRow[0].Properties.RowEdit = rite0;
                    editorRow[0].Properties.Value = "代码取值";
                    
                    editorRow[1] = new DevExpress.XtraVerticalGrid.Rows.EditorRow();
                    editorRow[1].Name = "editorRows0";
                    editorRow[1].Properties.Caption = "	                参数名称";
                    //editorRow[0].Properties.ReadOnly;
                    editorRow[1].Tag = "0";
                    //DevExpress.XtraEditors.Repository.RepositoryItemTextEdit rite0 = new DevExpress.XtraEditors.Repository.RepositoryItemTextEdit();
                    editorRow[1].Properties.RowEdit = rite0;
                    editorRow[1].Properties.Value = "代码取值";
                    //row.ChildRows.AddRange(new DevExpress.XtraVerticalGrid.Rows.BaseRow[] { editorRow[0] , editorRow[1] });
                    row.ChildRows.Add(editorRow[0]);
                }
                //存在子行，则只读
