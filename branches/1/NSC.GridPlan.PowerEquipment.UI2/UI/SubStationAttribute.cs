...
namespace NSC.GridPlan.PowerEquipment.UI
{
    ...
    /// <summary>
        ...
        private void textBus_EditValueChanged(object sender, EventArgs e)
        {
            ...
            const string
                //NewRow = "New",
                TableGV_SUBSTATION_BUSBAR = "[GV_SUBSTATION_BUSBAR]";
            DataSet ds = new DataSet();
        ...
        private void tabPage1_Click_1(object sender, EventArgs e)
        {
            ...
            DataSet ds = new DataSet();
            System.Data.OleDb.OleDbDataAdapter oleDbDataAdapter = new System.Data.OleDb.OleDbDataAdapter("SELECT TOP 5 * FROM " + TableGrid, "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" + DBFileName);

            DataBaseOp.SetWaitDialogCaption("Loading Order Details...");
            oleDbDataAdapter.Fill(ds, TableGrid);
            oleDbDataAdapter = new System.Data.OleDb.OleDbDataAdapter("SELECT TOP 4 ZBH FROM " + TableLookUp, "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" + DBFileName);
            DataBaseOp.SetWaitDialogCaption("Loading Products...");
            oleDbDataAdapter.Fill(ds, TableLookUp);
            //ds.Tables.AddRange();
            //ds.Tables[TableGrid].
        ...
        /// <param name="FieldLink"></param>
        /// <param name="iCount"></param>
        private void InitalGridControl(DevExpress.XtraVerticalGrid.VGridControl vGridControlx, string strGroupName, Dictionary<string, string> FieldName, Dictionary<string, object> FieldValue,  int iCount)
        {
            mCategoryRow = new DevExpress.XtraVerticalGrid.Rows.CategoryRow();
        ...
        private void textPcr_EditValueChanged(object sender, EventArgs e)
        {
            ...
            const string
                //NewRow = "New",
                TableGV_SUBSTATION_PCR = "[GV_SUBSTATION_PCR]";
            DataSet ds = new DataSet();
        ...
        public void megreGridControl(DevExpress.XtraVerticalGrid.VGridControl vGridControlm)
        {
            for (int j = 0; j < vGridControlm.Rows.Count; j++)
            {
                ...
                this.vGridControl5.Rows.Add(vGridControlm.Rows[j]);
                //this.vGridControl1.Rows.Add(vGridControlm.Rows[j]);
            }
            this.vGridControl5.BestFit();
            this.vGridControl5.OptionsView.FixRowHeaderPanelWidth = true;
            this.vGridControl5.OptionsView.AutoScaleBands = true;
            this.vGridControl5.OptionsBehavior.Editable = false;
        }
        ...
        {
            megreGridControl(vGridDdtial);
            megreGridControl(vGridControl2);
        }
