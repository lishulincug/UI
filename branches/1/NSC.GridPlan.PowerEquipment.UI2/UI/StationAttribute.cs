...
namespace NSC.GridPlan.PowerEquipment.UI
{
    public partial class StationAttribute : Form
    {
        ...
        private void textEdit1_EditValueChanged(object sender, EventArgs e)
        {
            ...
            System.Data.OleDb.OleDbDataAdapter oleDbDataAdapter = new System.Data.OleDb.OleDbDataAdapter("SELECT * FROM " + TableGrid, "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" + DBFileName);
            ...
            //ds.Tables.AddRange();
            this.vGridControl2.DataSource = ds.Tables[TableLookUp];
        ...
        private void Trans_EditValueChanged(object sender, EventArgs e)
        {
            ...
            const string
                //NewRow = "New",
                TableGV_AC_SUBSTATION_PT = "[GV_AC_SUBSTATION_PT]";
            DataSet ds = new DataSet();
